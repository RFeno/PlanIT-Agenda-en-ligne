            ...
            <div class="flex -mx-4 items-center justify-between relative">
                ...
                <div id="logoImage" class="px-4 w-60 max-w-full">
                            <a href="#" class="navbar-logo w-full block py-5">
                                <img src="app/images/logo.png" alt="logo de plan it" class="w-9/12 header-logo"/>
                            </a>
                </div>
                <!--fin logo -->
                <div class="flex px-4 justify-between items-center w-full">        
                    <div>
                        ...
                        <div class="sm:flex justify-end hidden pr-16 lg:pr-0">
                            <a href="db/connexion/inscription.php" class="text-base font-medium
                            text-white hover:opacity-70 py-3 px-7 loginBtn ">
                            S'inscrire
                            </a>
                            <a href="db/connexion/connexion.php" class="text-base font-medium
        ...
        <div class="sm:text-center lg:text-left">
          ...
          <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
            <div class="rounded-md shadow">
              <a href="db/connexion/inscription.php" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-800 hover:bg-white hover:text-blue-800 md:py-4 md:text-lg md:px-10"> S'inscrire </a>
            </div>
            <div class="mt-3 sm:mt-0 sm:ml-3">
              <a href="db/connexion/connexion.php" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-blue-700 bg-blue-100 hover:bg-blue-300 hover:text-white md:py-4 md:text-lg md:px-10"> Se connecter </a>
            </div>
          </div>
        </div>
       </section>
